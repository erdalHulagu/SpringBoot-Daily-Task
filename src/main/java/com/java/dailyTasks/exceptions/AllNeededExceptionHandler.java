...
import com.java.dailyTasks.exception.message.ApiResponseError;


@ControllerAdvice // merkezi exception handle etmek için @ControllerAdvice ekledim
public class AllNeededExceptionHandler  extends ResponseEntityExceptionHandler{
	...
	Logger logger = LoggerFactory.getLogger(AllNeededExceptionHandler.class);
